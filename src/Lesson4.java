...
public class Lesson4 {
    ...
    2. для определения победителя проходим циклом по этому массиву и считаем количество фишек по направлениям: вертикаль, горизонталь, диагональ слева направо верхняя половина
    диагональ слева направо нижняя половина, аналогично диагональ справа налево
    ...
    складываются ячейки, в которые нужно поставить свою фишку и из них рандомно выбирается следующий ход.
     */
